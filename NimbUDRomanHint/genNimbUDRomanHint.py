...
todoList = [
    ...
    FINFO(
        'Bold',
        "../srcfonts/urw-core35-fonts/NimbusRoman-Bold.otf",
        "../srcfonts/morisawa-biz-ud-gothic/fonts/ttf/BIZUDPGothic-Bold.ttf"
    ),
    FINFO(
        'Italic',
        "../srcfonts/urw-core35-fonts/NimbusRoman-Italic.otf",
        "../srcfonts/morisawa-biz-ud-gothic/fonts/ttf/BIZUDPGothic-Regular.ttf"
    ),
    FINFO(
        'BoldItalic',
        "../srcfonts/urw-core35-fonts/NimbusRoman-BoldItalic.otf",
        "../srcfonts/morisawa-biz-ud-gothic/fonts/ttf/BIZUDPGothic-Bold.ttf"
    ),
