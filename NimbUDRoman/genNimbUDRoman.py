...
todoList = [
    FINFO(
        'Regular',
        "../srcfonts/urw-base35/NimbusRoman-Regular.otf",
        "../srcfonts/morisawa-biz-ud-mincho/morisawa-biz-ud-mincho-fonts/fonts/ttf/BIZUDPMincho-Regular.ttf"
    ),
    FINFO(
        'Bold',
        "../srcfonts/urw-base35/NimbusRoman-Bold.otf",
        "../srcfonts/morisawa-biz-ud-gothic/morisawa-biz-ud-gothic-fonts/fonts/ttf/BIZUDPGothic-Bold.ttf"
    ),
    FINFO(
        'Italic',
        "../srcfonts/urw-base35/NimbusRoman-Italic.otf",
        "../srcfonts/morisawa-biz-ud-gothic/morisawa-biz-ud-gothic-fonts/fonts/ttf/BIZUDPGothic-Regular.ttf"
    ),
    FINFO(
        'BoldItalic',
        "../srcfonts/urw-base35/NimbusRoman-BoldItalic.otf",
        "../srcfonts/morisawa-biz-ud-gothic/morisawa-biz-ud-gothic-fonts/fonts/ttf/BIZUDPGothic-Bold.ttf"
    ),
